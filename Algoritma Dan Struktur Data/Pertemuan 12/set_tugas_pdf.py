...
Pop() adalah metode bawaan dalam Python yang digunakan
untuk memunculkan atau menghapus elemen satu per satu
dari kumpulan. Elemen terkecil dalam himpunan
dihilangkan terlebih dahulu, diikuti dengan penghapusan
elemen secara bertahap. Dalam program berikut,
perulangan while melanjutkan penghapusan elemen satu
per satu, hingga himpunan tersebut kosong.
...
Kode ini memeriksa apakah set s2 adalah subset dari set
s1 dan mencetak True jika itu adalah.
s1 = {1, 2, 3, 4, 5}
s2 = {4, 5}
